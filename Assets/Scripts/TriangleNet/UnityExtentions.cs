...
namespace TriangleNet
{
    ...
    {
        public static void Add(this Geometry.Polygon polygon, List<Vector2> contour, bool isHole = false)
        {
            polygon.Add(new Contour(contour.ToTriangleNetVertices()), isHole);
        }

        public static void Add(this Geometry.Polygon polygon, Vector2 vertex)
        {
